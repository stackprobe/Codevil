...
static void SettingMenu(void)
{
	...
	for(; ; )
	{
		selectIndex = SimpleMenu("設定", MENU_ITEMS, lengthof(MENU_ITEMS), selectIndex);
		...
		case 2:
			SimpleVolumeConfig("ＢＧＭ音量", Gnd.MusicVolume, 0, 100, 1, 10, BGMVolumeChanged); 
			break;

		case 3:
			SimpleVolumeConfig("ＳＥ音量", Gnd.SEVolume, 0, 100, 1, 10, SEVolumeChanged, SEVolumePulse); 
			break;
